...
<template>
    <div class="p-6 max-w-7xl mx-auto">
        <h1 class="text-2xl font-bold mb-4">Lista de Personas registradas</h1>

        <table
            class="w-full text-sm text-left text-gray-700 bg-white shadow-md rounded-lg overflow-hidden"
        >
