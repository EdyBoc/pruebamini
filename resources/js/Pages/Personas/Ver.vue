...
<template>
    <div class="p-6 max-w-3xl mx-auto">
        ...
        <table
            class="w-full text-sm text-left text-gray-700 bg-white shadow-lg rounded-xl overflow-hidden"
        >
            <thead
                class="text-xs uppercase bg-gradient-to-r from-blue-700 to-blue-500 text-white"
            >
                <tr>
            ...
            <tbody>
                <tr
                    v-for="p in personas"
                    :key="p.id"
                    class="border-b hover:bg-blue-50 transition duration-150 ease-in-out"
                >
                    <td
        ...
        <div
            v-if="rol === 'Técnico Analista' && modoEdicion"
            class="mt-10 bg-white p-8 rounded-lg shadow-md"
        >
            ...
            <form @submit.prevent="guardarPersona" class="space-y-6">
                <div class="space-y-4">
                    <div>
                        ...
                        />
                        <p
                            v-if="errores.primer_nombre"
                            class="text-red-600 text-sm"
                        >
                            {{ errores.primer_nombre[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p
                            v-if="errores.segundo_nombre"
                            class="text-red-600 text-sm"
                        >
                            {{ errores.segundo_nombre[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p
                            v-if="errores.apellido_casada"
                            class="text-red-600 text-sm"
                        >
                            {{ errores.apellido_casada[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="border w-full p-2 rounded"
                        />
                        <p v-if="errores.cui" class="text-red-600 text-sm">
                            {{ errores.cui[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="border w-full p-2 rounded"
                        />
                        <p v-if="errores.telefono" class="text-red-600 text-sm">
                            {{ errores.telefono[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="border w-full p-2 rounded"
                        />
                        <p v-if="errores.email" class="text-red-600 text-sm">
                            {{ errores.email[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="border w-full p-2 rounded"
                        />
                        <p v-if="errores.sexo" class="text-red-600 text-sm">
                            {{ errores.sexo[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p
                            v-if="errores.estado_civil"
                            class="text-red-600 text-sm"
                        >
                            {{ errores.estado_civil[0] }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full"
                        />
                        <p v-if="errores.archivo" class="text-red-600 text-sm">
                            {{ errores.archivo[0] }}
                        </p>
                    </div>
                </div>
        ...
        <div v-if="rol === 'Usuario Normal'" class="mt-8 text-center">
            <a
                href="/personas/crear"
                class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded shadow transition-colors duration-300"
            >
                Crear
            </a>
        </div>
